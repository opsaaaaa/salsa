$(function() {
  ...
  $('#tb_send_canvas').on('ajax:beforeSend', function(event, xhr, settings) {
    ...
    $('.canvas-hide, .hide, #page_break, .page-break, .content:has(#grade_scale.inactive), .disabled, #spacer, [style*="display: none;"], .dynamic-component, script', salsaDocument).remove();
